...
type TBoard struct {
	...
	Key          string          `protobuf:"bytes,2,opt,name=key,proto3" json:"key,omitempty"` //У задачи должен быть кей
...
var file_board_proto_rawDesc = []byte{
	...
	0x61, 0x62, 0x6c, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x73, 0x22, 0x2d, 0x0a, 0x07, 0x54, 0x53, 0x70,
	0x72, 0x69, 0x6e, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
